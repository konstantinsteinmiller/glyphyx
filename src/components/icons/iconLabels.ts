...
export const ICON_LABEL_KEYS: Partial<Record<GameIconName, string>> = {
  ...
  // Glyphyx: the forge, the map, the skin shop and the rune glyphs.
  forge: 'forge.label',
  map: 'campaign.title',
  skin: 'skins.title',
  gem: 'skins.title',
  sword: 'runes.names.melee',
  bow: 'runes.names.archer',
  orb: 'runes.names.mage',
  cross: 'runes.names.support',
  cleave: 'runes.names.cleave',
