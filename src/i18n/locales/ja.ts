export default {
  ...
  'hints': {
    'drag': {
      'touch': '向けたい向きの、マスの「その側」で離す',
      'desktop': '向けたい向きの、マスの「その側」で離す'
    },
    'aim': {
      'touch': '向けたい辺で指を離す',
    ...
    'lateAim': {
      'touch': 'もう置いてある — 離した側が向きを決める',
      'desktop': 'もう置いてある — 離した側が向きを決める'
    },
    'mage': {
    ...
    'clash': {
      'touch': '同じマスの2つはぶつかって砕ける — 頑丈なほうが残る',
      'desktop': '同じマスの2つはぶつかって砕ける — 頑丈なほうが残る'
    },
    'correct': {
